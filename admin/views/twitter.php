...
<div class=line></div>
<div id="tw" class="media">
    <div class="main_img pull-left"><a href="./blogger.php"><img src="<?php echo $avatar; ?>" height="48" width="48" /></a></div>
    <div class="media-body" style="margin-bottom: 20px;">
        <form method="post" action="twitter.php?action=post">
            <input type="hidden" name="img" id="imgPath" />
            <input name="token" id="token" value="<?php echo LoginAuth::genToken(); ?>" type="hidden" />
<!--            <div class="box_1">-->
                <textarea class="box form-control" name="t" placeholder="微语内容..."></textarea>
<!--            </div>-->
            <div class="form-inline" style="clear: both;margin: 10px 0;">
                <div id="img_name" class="twImg form-group" style="display:none;">
                    <a id="img_name_a" class="imgicon btn btn-default" href="javascript:;" onmouseover="$('#img_pop').show();" onmouseout="$('#img_pop').hide();">{图片名称}</a>
                    <a href="javascript:;" onclick="unSelectFile()" class="btn btn-default">取消</a>
                    <div id="img_pop"></div>
                </div>
                <div class="form-group">
                    <div class="twImg" id="img_select"><input type="file" height="30" name="Filedata" id="custom_file_upload" style="display: none;"></div>
                </div>
                <div class="form-group">
                    <div class="btn btn-default" id="face"><span class="fa fa-smile-o" style="font-size: 18px;"></span></div>
                </div>
                <div class="form-group">
                    <input type="submit" value="发布" onclick="return checkt();" class="btn btn-primary"/>
                </div>
                <div class="form-group pull-right">
                    <div class="msg text-gray">你还可以输入140字</div>
                </div>
            </div>
            <!--            <img class="twImg btn btn-default btn-sm" id="face" style="margin-right: 10px;cursor: pointer;" src="./views/images/face.png">-->
    ...
    ?>
    <li class="media">
        <div class="main_img pull-left"><img src="<?php echo $avatar; ?>" width="32px" height="32px" /></div>
        <div class="media-body">
            <h4 class="media-heading"><?php echo $author; ?></h4>
