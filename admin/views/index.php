...
<div id="admindex_main">
    <div id="tw" class="media">
        <div class="main_img pull-left"><a href="./blogger.php"><img src="<?php echo $avatar; ?>" height="48" width="48" class="img-rounded"/></a></div>
        <div class="media-body">
        <form method="post" action="twitter.php?action=post">
            <div class="box_1">
                <textarea class="box2 form-control" name="t" placeholder="用微语记录生活……"></textarea>
            </div>
            <div class="tbutton" style="display:none;">
                <input type="submit" value="发布" onclick="return checkt();" class="btn btn-primary"/>
                <a href="javascript:closet();" class="btn btn-default">取消</a> <span>(你还可以输入140字)</span>
...
<div id="admindex_servinfo" class="col-md-6">
    <h3>站点信息</h3>
...
<div id="admindex_msg" class="col-md-6">
    <h3>官方消息</h3>
